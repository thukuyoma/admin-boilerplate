...
export default function FilterOnlineScholarships() {
  ...
  const { isLoading, isError, isSuccess, error, isPreviousData, isFetching } = useQuery(
    ['scholarships', page],
    () => filterScholarship({ page, limit, status: 'online' }),
    {
  ...
  const overlayItems: Array<{ title: string; url: string; isActive: boolean }> = [
    { title: `Online (${query.totalScholarships})`, url: '/scholarships', isActive: true },
