...
export default function FilterOpenSupport() {
  ...
  const { isLoading, isError, isSuccess, error, isPreviousData, isFetching } = useQuery(
    ['Opened supports ticket', page],
    () => filterSupports({ page, limit, status: 'open' }),
    {
  ...
  const overlayItems: Array<{ title: string; url: string; isActive: boolean }> = [
    { title: `Open Tickets (${query.totalSupports})`, url: '/supports', isActive: true },
  ]
